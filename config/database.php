    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv' => [
            ...
            'database' => env('DB_SQLSRV_DATABASE', 'AINData'),
        ...
        'timedata' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_TIMEDATA_HOST', 'localhost'),
            'port' => env('DB_TIMEDATA_PORT', '1433'),
            'database' => env('DB_TIMEDATA_DATABASE', 'TIMEData'),
            'username' => env('DB_TIMEDATA_USERNAME', 'sa'),
            'password' => env('DB_TIMEDATA_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'encrypt' => 'yes',
